...
import { add_Subcategory } from '../../../APi/Routehandlers'
...
const SubCategory = () => {
  ...
  const handle_submit = async (e) => {
    e.preventDefault()
    try {
      const response = await add_Subcategory('/subcategories/add', data)
      console.log(response)
      if (response.status === 201)
        settoast(
          <CToast autohide color="success" className="text-white">
            <CToastHeader closeButton>SubCategory Added!</CToastHeader>
            <CToastBody>Check the SubCategory Section to view the ID</CToastBody>
          </CToast>,
        )
      setcategoryName('')
      setcategoryId('')
                ...
                <CCardBody>
                  <CForm onSubmit={handle_submit}>
                    ...
                    <CInputGroup className="mb-3">
                      ...
                      <CFormInput
                        placeholder="Enter the main category ID"
                        value={categoryId}
